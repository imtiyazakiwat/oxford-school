    ...
    <main className="min-h-screen bg-gray-50">
      <div className="bg-[#c41e3a] py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white" style={{ fontFamily: "var(--font-display)" }}>{t("page.feeStructure")}</h1>
          <p className="text-white/80 mt-4 max-w-2xl">{t("page.feeDesc")}</p>
        </div>
      </div>
