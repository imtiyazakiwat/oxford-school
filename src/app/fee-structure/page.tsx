      ...
      <div className="bg-[#c41e3a] py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-white/80 mt-4 max-w-2xl">
            View detailed fee structure for all courses offered at New Oxford Coaching Classes.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
          <div className="w-20 h-20 bg-[#c41e3a]/10 rounded-full flex items-center justify-center mx-auto mb-6">
            <IndianRupee className="w-10 h-10 text-[#c41e3a]" />
          </div>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Coming Soon</h2>
          <p className="text-gray-600 max-w-md mx-auto mb-8">
            We&apos;re updating the fee structure for the new academic year. Check back soon for detailed information.
          </p>
          <Link
            href="/"
