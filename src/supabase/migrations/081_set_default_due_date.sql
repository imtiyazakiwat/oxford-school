-- Migration: Set default due_date in auto-assign functions
-- due_date = March 31st of the ending academic year (e.g., 2025-2026 -> 2026-03-31)
...
BEGIN
    ...
    -- Calculate due date: March 31st of the ending year (splitting '2025-2026' -> 2026)
...
BEGIN
    ...
    SELECT 
        ...
        fs.exam_fee,
        fs.other_fee,
        -- Calculate due date directly in SQL
